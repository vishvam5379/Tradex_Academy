...
urlpatterns = [
    ...
    path('upload-url/', views_admin.admin_lecture_upload_url_api, name='admin_lecture_upload_url'),
    path('confirm/', views_admin.admin_lecture_confirm_api, name='admin_lecture_confirm'),
